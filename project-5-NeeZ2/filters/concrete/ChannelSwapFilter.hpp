...
public:
     ...
     */
    ChannelSwapFilter(Channel c1, Channel c2, double strength = DEFAULT_STRENGTH);
    ...
    /**
     * @brief Creates a deep copy of this ChannelSwapFilter.
     *
     * @return A std::shared_ptr<ImageFilter> pointing to the new ChannelSwapFilter copy.
     */
